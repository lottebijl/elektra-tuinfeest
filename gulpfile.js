...
(function () {
  ...
  styles: {
    ...
    vendor: [
      ...
      directories.node + '/wow/css/libs/animate.css',
      directories.node + '/foundation-sites/dist/css/foundation.css',
      directories.node + '/swiper/dist/css/swiper.css',
      directories.node + '/easy-autocomplete/dist/easy-autocomplete.min.css',
      directories.node + '/slick-carousel/slick/slick-theme.css',
  ...
  scripts: {
    ...
    vendor: [
      ...
      directories.node + '/wowjs/dist/wow.js',
      directories.node + '/foundation-sites/dist/js/foundation.js',
      directories.node + '/swiper/dist/js/swiper.js',
      directories.node + '/jquery.countdown/jquery.countdown.min.js',
      directories.src + '/scripts/vendor/**/*.js',
      directories.src + '/scripts/vendor/gsap/TweenMax.min.js',
      directories.src + '/scripts/vendor/gsap/easing/CustomEase.min.js',
      directories.src + '/scripts/vendor/parallax.min.js',
      directories.src + '/scripts/vendor/jquery.countdown.min.js',
      directories.node + '/slick-carousel/slick/slick.js',
  ...
  gulp.task('createTemplates', function () {
    return gulp.src(['app/views/*.php', 'app/views/*.html'])
...
gulp.task('api', function() {
  ...
  gulp.task('watch', function () {
    ...
    gulp.watch(['app/views/modules/**/*.html', 'app/views/modules/**/*.php', 'app/views/*.html', 'app/views/*.php'], ['html']);
  ...
  gulp.task('html', function (cb) {
    runSequence('api', 'createTemplates', 'combineSources', cb);
  });
